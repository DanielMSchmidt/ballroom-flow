...
const FULL_LABEL_EN: Record<string, Record<string, string>> = {
  ...
  footwork: {
    ...
    BHB: "Ball-Heel-Ball",
    HBH: "Heel-Ball-Heel",
    "I/E of B": "Inside edge of ball",
    "I/E of BH": "Inside edge of ball-heel",
    "O/E of T, BH": "Outside edge of toe, ball-heel",
    BH: "Ball-heel",
    HTH: "Heel-Toe-Heel",
    THT: "Toe-Heel-Toe",
    "T/H/T": "Toe / Heel / Toe",
...
const FULL_LABEL_DE: typeof FULL_LABEL_EN = {
  ...
  footwork: {
    ...
    BT: "Ballen-Spitze",
    TB: "Spitze-Ballen",
    THB: "Spitze-Ferse-Ballen",
    BHB: "Ballen-Ferse-Ballen",
    HBH: "Ferse-Ballen-Ferse",
    "I/E of B": "Innenkante des Ballens",
    "I/E of BH": "Innenkante Ballen-Ferse",
    "O/E of T, BH": "Außenkante der Spitze, Ballen-Ferse",
    BH: "Ballen-Ferse",
