...
- **Copy-on-write** carries `bars` onto the frozen choreo-owned copy along with attributes (§2.4) — changing a figure's length outside the choreo forks it just like any other edit.
